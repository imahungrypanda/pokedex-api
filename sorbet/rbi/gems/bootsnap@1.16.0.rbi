...
module Bootsnap
  ...
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:3
  def instrumentation_enabled=(_arg0); end

  class << self
    # pkg:gem/bootsnap#lib/bootsnap.rb:34
    def _instrument(event, path); end

    # pkg:gem/bootsnap#lib/bootsnap.rb:122
    def absolute_path?(path); end

    # pkg:gem/bootsnap#lib/bootsnap.rb:70
    def default_setup; end

    # pkg:gem/bootsnap#lib/bootsnap.rb:27
    def instrumentation=(callback); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:3
    def instrumentation_enabled=(_arg0); end

    # pkg:gem/bootsnap#lib/bootsnap.rb:14
    def log!; end

    # pkg:gem/bootsnap#lib/bootsnap.rb:12
    def logger; end

    # pkg:gem/bootsnap#lib/bootsnap.rb:18
    ...
    #
    # pkg:gem/bootsnap#lib/bootsnap.rb:130
    ...
    # pkg:gem/bootsnap#lib/bootsnap.rb:66
...
module Bootsnap::CompileCache
  class << self
    # pkg:gem/bootsnap#lib/bootsnap/compile_cache.rb:46
    def permission_error(path); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache.rb:13
    def setup(cache_dir:, iseq:, yaml:, json:, readonly: T.unsafe(nil)); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache.rb:55
    def supported?; end
  end
end
...
module Bootsnap::CompileCache::ISeq
  class << self
    ...
    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:101
    def compile_option_updated; end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:59
    def fetch(path, cache_dir: T.unsafe(nil)); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:76
    def input_to_output(_data, _kwargs); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:41
    ...
    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:48
    def storage_to_output(binary, _args); end
  end
end

# pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:80
module Bootsnap::CompileCache::ISeq::InstructionSequenceMixin
  ...
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/iseq.rb:81
  def load_iseq(path); end
end

# pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:7
module Bootsnap::CompileCache::JSON
  class << self
    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:10
    def cache_dir; end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:12
    def cache_dir=(cache_dir); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:48
    def init!; end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:28
    def input_to_output(data, kwargs); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:16
    def input_to_storage(payload, _); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:40
    def install!(cache_dir); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:9
    def msgpack_factory; end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:9
    def msgpack_factory=(_arg0); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:32
    def precompile(path); end

    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:21
    ...
    # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:62
    def supports_freeze?; end
  end
end

# pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:68
module Bootsnap::CompileCache::JSON::Patch
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/json.rb:69
...
# pkg:gem/bootsnap#lib/bootsnap/compile_cache.rb:11
...
module Bootsnap::CompileCache::YAML::Psych3
  ...
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:297
  def input_to_output(data, kwargs); end

  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:275
  def input_to_storage(contents, _); end

  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:287
  def storage_to_output(data, kwargs); end
end

# pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:301
module Bootsnap::CompileCache::YAML::Psych3::Patch
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:302
  def load_file(path, *args, **_arg2); end

  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:326
...
# pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:221
module Bootsnap::CompileCache::YAML::Psych4::Patch
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:222
  def load_file(path, *args, **_arg2); end
...
module Bootsnap::CompileCache::YAML::Psych4::UnsafeLoad
  ...
  # pkg:gem/bootsnap#lib/bootsnap/compile_cache/yaml.rb:176
  def input_to_output(data, kwargs); end
...
# pkg:gem/bootsnap#lib/bootsnap.rb:9
...
class Bootsnap::LoadPathCache::Cache
  ...
  # loadpath.
  #
  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:48
  ...
  # is "/a/b".
  #
  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:22
  def load_dir(dir); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:108
  def push_paths(sender, *paths); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:114
  def reinitialize(path_obj = T.unsafe(nil)); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:102
  def unshift_paths(sender, *paths); end

  private

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:127
  def dir_changed?; end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:172
  def expand_path(feature); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:203
  def maybe_append_extension(feature); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:180
  def now; end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:137
  def push_paths_locked(*paths); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:199
  def search_index(feature); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:176
  def stale?; end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:231
  def try_ext(feature); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:211
  def try_index(feature); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:155
...
#
# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/cache.rb:28
...
module Bootsnap::LoadPathCache::ChangeObserver
  class << self
    # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/change_observer.rb:59
    def register(arr, observer); end

    # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/change_observer.rb:68
...
class Bootsnap::LoadPathCache::Path
  ...
  # of this +Path+.
  #
  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:59
  def entries_and_dirs(store); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:82
  ...
  # /a/b/c, pass ('/a/b', ['c'])
  #
  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:99
  def latest_mtime(path, dirs); end

  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:92
  def scan!; end
...
#
# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:120
Bootsnap::LoadPathCache::Path::RUBY_LIBDIR = T.let(T.unsafe(nil), String)

# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:121
...
# often.
#
# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:115
Bootsnap::LoadPathCache::Path::STABLE = T.let(T.unsafe(nil), Symbol)

# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path.rb:116
...
module Bootsnap::LoadPathCache::PathScanner
  class << self
    # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path_scanner.rb:23
    def call(path); end
    ...
    # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path_scanner.rb:69
    def os_path(path); end

    # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path_scanner.rb:49
...
# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path_scanner.rb:12
Bootsnap::LoadPathCache::PathScanner::BUNDLE_PATH = T.let(T.unsafe(nil), String)

# pkg:gem/bootsnap#lib/bootsnap/load_path_cache/path_scanner.rb:9
...
module Kernel
  ...
  # pkg:gem/bootsnap#lib/bootsnap/load_path_cache/core_ext/kernel_require.rb:8
