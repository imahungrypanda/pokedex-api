...
module Listen
  class << self
    ...
    # pkg:gem/listen#lib/listen/logger.rb:10
    ...
    # pkg:gem/listen#lib/listen/logger.rb:18
...
class Listen::Adapter::BSD < ::Listen::Adapter::Base
  ...
  # pkg:gem/listen#lib/listen/adapter/bsd.rb:73
  def _change(event_flags); end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:43
  def _configure(directory, &callback); end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:82
  def _event_path(event); end

  # Quick rubocop workaround
  #
  # pkg:gem/listen#lib/listen/adapter/bsd.rb:102
  def _find(*paths, &block); end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:55
  def _process_event(dir, event); end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:51
  def _run; end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:95
  def _watch_file(path, queue); end

  # pkg:gem/listen#lib/listen/adapter/bsd.rb:86
  def _watch_for_new_file(event); end

  class << self
    # pkg:gem/listen#lib/listen/adapter/bsd.rb:31
    def usable?; end
  end
end
...
class Listen::Event::Config
  ...
  # pkg:gem/listen#lib/listen/event/config.rb:27
  def call(*args); end

  # pkg:gem/listen#lib/listen/event/config.rb:31
  def callable?; end
  ...
  # pkg:gem/listen#lib/listen/event/config.rb:35
  def optimize_changes(changes); end

  # pkg:gem/listen#lib/listen/event/config.rb:23
  def sleep(seconds); end
end

# pkg:gem/listen#lib/listen/event/loop.rb:12
class Listen::Event::Loop
  include ::Listen::FSM
  extend ::Listen::FSM::ClassMethods

  # pkg:gem/listen#lib/listen/event/loop.rb:24
  def initialize(config); end

  # pkg:gem/listen#lib/listen/event/loop.rb:62
  def pause; end

  # @raises Error::NotStarted if background thread hasn't started in MAX_STARTUP_SECONDS
  #
  # pkg:gem/listen#lib/listen/event/loop.rb:44
  def start; end

  # pkg:gem/listen#lib/listen/event/loop.rb:37
  def started?; end

  # pkg:gem/listen#lib/listen/event/loop.rb:67
  def stop; end

  # pkg:gem/listen#lib/listen/event/loop.rb:74
  def stopped?; end

  # pkg:gem/listen#lib/listen/event/loop.rb:31
  def wakeup_on_event; end

  private

  # pkg:gem/listen#lib/listen/event/loop.rb:80
  def _process_changes; end

  # pkg:gem/listen#lib/listen/event/loop.rb:88
  def _wakeup(reason); end
end

# pkg:gem/listen#lib/listen/event/loop.rb:15
Listen::Event::Loop::Error = Listen::Error

# pkg:gem/listen#lib/listen/event/loop.rb:41
Listen::Event::Loop::MAX_STARTUP_SECONDS = T.let(T.unsafe(nil), Float)

# pkg:gem/listen#lib/listen/event/loop.rb:16
...
class Listen::Event::Processor
  ...
  # pkg:gem/listen#lib/listen/event/processor.rb:94
  def _flush_wakeup_reasons; end

  # for easier testing without sleep loop
  #
  # pkg:gem/listen#lib/listen/event/processor.rb:102
  ...
  #
  # pkg:gem/listen#lib/listen/event/processor.rb:88
  ...
  # pkg:gem/listen#lib/listen/event/processor.rb:123
  def config; end
end
...
# pkg:gem/listen#lib/listen/event/queue.rb:9
class Listen::Event::Queue
  extend ::Forwardable

  # pkg:gem/listen#lib/listen/event/queue.rb:22
  def initialize(config); end

  # pkg:gem/listen#lib/listen/event/queue.rb:27
  def <<(args); end

  # pkg:gem/listen#lib/listen/event/queue.rb:43
  def close(*args, **_arg1, &block); end

  # pkg:gem/listen#lib/listen/event/queue.rb:41
  def empty?(*args, **_arg1, &block); end

  # pkg:gem/listen#lib/listen/event/queue.rb:42
  def pop(*args, **_arg1, &block); end

  private

  # pkg:gem/listen#lib/listen/event/queue.rb:47
  def _safe_relative_from_cwd(dir); end
end

# pkg:gem/listen#lib/listen/event/queue.rb:12
class Listen::Event::Queue::Config
  # pkg:gem/listen#lib/listen/event/queue.rb:13
  def initialize(relative); end

  # pkg:gem/listen#lib/listen/event/queue.rb:17
  def relative?; end
end
...
module Listen::FSM
  ...
  #
  # pkg:gem/listen#lib/listen/fsm.rb:42
  def initialize_fsm; end

  # Current state of the FSM, stored as a symbol
  #
  # pkg:gem/listen#lib/listen/fsm.rb:50
  def state; end
...
module Listen::FSM::ClassMethods
  ...
  #
  # pkg:gem/listen#lib/listen/fsm.rb:35
  ...
  #
  # pkg:gem/listen#lib/listen/fsm.rb:28
  def states; end
end

# pkg:gem/listen#lib/listen/fsm.rb:112
class Listen::FSM::State
  # pkg:gem/listen#lib/listen/fsm.rb:115
  def initialize(name, transitions, &block); end

  # pkg:gem/listen#lib/listen/fsm.rb:123
  def call(obj); end
  ...
  # pkg:gem/listen#lib/listen/fsm.rb:127
...
class Listen::Options
  ...
  # pkg:gem/listen#lib/listen/options.rb:20
  def method_missing(name, *_); end

  private

  # pkg:gem/listen#lib/listen/options.rb:16
...
class Listen::Record
  # pkg:gem/listen#lib/listen/record.rb:14
  def initialize(directory, silencer); end

  # pkg:gem/listen#lib/listen/record.rb:20
  def add_dir(rel_path); end

  # pkg:gem/listen#lib/listen/record.rb:62
  def build; end

  # pkg:gem/listen#lib/listen/record.rb:46
  def dir_entries(rel_path); end

  # pkg:gem/listen#lib/listen/record.rb:36
  def file_data(rel_path); end

  # TODO: one Record object per watched directory?
  # TODO: deprecate
  #
  # pkg:gem/listen#lib/listen/record.rb:12
  def root; end

  # pkg:gem/listen#lib/listen/record.rb:31
  def unset_path(rel_path); end

  # pkg:gem/listen#lib/listen/record.rb:26
  def update_file(rel_path, data); end

  private

  # pkg:gem/listen#lib/listen/record.rb:103
  def _fast_build_dir(remaining, symlink_detector); end

  # pkg:gem/listen#lib/listen/record.rb:117
  def _fast_try_file(entry); end

  # pkg:gem/listen#lib/listen/record.rb:91
  def _fast_unset_path(dirname, basename); end

  # pkg:gem/listen#lib/listen/record.rb:83
  def _fast_update_file(dirname, basename, data); end

  # pkg:gem/listen#lib/listen/record.rb:75
  def empty_dirname?(dirname); end

  # pkg:gem/listen#lib/listen/record.rb:79
  def reset_tree; end
end
